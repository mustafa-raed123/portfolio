...
export default function Projects() {
  return (
    ...
    <h2 className='text-2xl mt-3 pl-1'>EduLink</h2>
    <p className='text-gray-300 pl-1 flex-grow text-justify'> 
    ...
    <p className='mt-4 flex-shrink-0 mb-4 pl-1'> 
        ...
        <h2 className='text-2xl mt-3 pl-1'>Nova Bank</h2>
        <p className='text-gray-300 flex-grow text-justify pl-1'> Bank System is a comprehensive banking application designed to simplify financial transactions and 
    ...
    <h2 className='text-2xl mt-3 pl-1'>Dern Support</h2>
    <p className='text-gray-300  pl-1 flex-grow text-justify'> 
